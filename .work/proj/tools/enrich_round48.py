#!/usr/bin/env python3
"""Enrich the 182 non-deferred questions in the 200-question round48 scope.
...
from round48_items import ITEMS
from round48_lessons import LESSONS

ROOT = Path(__file__).resolve().parents[1]
DEFERRED = {(23, n) for n in (68, 77, 88, 95, 98, 102, 118, 137, 144, 152, 157, 163, 176, 182, 190, 195, 202, 203)}
SCOPE = {(23, n) for n in range(41, 221)} | {(24, n) for n in range(1, 21)}
...
def enrich():
    ...
    print('PASS: enriched 182 (part23:162, part24:20); 18 new deferred unchanged; all keys/stems/options preserved.')
